# this script is from https://github.com/kohya-ss/sd-scripts/blob/main/finetune/tag_images_by_wd14_tagger.py
# it is a reference for executing the wd14 checkpoint
